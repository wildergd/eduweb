#ifndef MASTERPROGRAMPROJECT_H
#define MASTERPROGRAMPROJECT_H
...
class MasterProgramProject: public QObject, public IProject, public IProjectContainer, public IConfigurable
{
	Q_OBJECT
...
public:
	...
	//static void createDefaults(MasterProgram * masterProgram);

private:	
	static SettingsManager* settings;
};

#endif // MASTERPROGRAMPROJECT_H
