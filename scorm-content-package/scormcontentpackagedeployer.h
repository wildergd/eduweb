#ifndef SCORMCONTENTPACKAGEDEPLOYER_H
#define SCORMCONTENTPACKAGEDEPLOYER_H
...
class SCORMContentPackageDeployer: public QObject, public IDeployer
{
	Q_OBJECT
...
#endif // SCORMCONTENTPACKAGEDEPLOYER_H
