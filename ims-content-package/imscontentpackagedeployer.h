#ifndef IMSCONTENTPACKAGEDEPLOYER_H
#define IMSCONTENTPACKAGEDEPLOYER_H
...
class IMSContentPackageDeployer: public QObject, public IDeployer
{
	Q_OBJECT
...
#endif // IMSCONTENTPACKAGEDEPLOYER_H
